        ...
        <div class="card-body">
          ...
          <form class="user" action="{{ route('rm.update') }}" method="post">
            ...
            <div class="table-responsive">
              <table class="table table-bordered table-striped" id="x_fisik" width="100%" cellspacing="0">
                <thead>
                  <tr>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                @if ($data->lab != null)
                  @for ($i = 0; $i < $num['lab']; $i++)
                    <li> {{ get_value('lab', array_keys($data->labhasil)[$i], 'nama') }} :
                      {{ $data->labhasil[array_keys($data->labhasil)[$i]] }}
                      {{ get_value('lab', array_keys($data->labhasil)[$i], 'satuan') }} </li>
              ...
              <div class="col-sm-8">
                @if ($data->resep != null)
                  @for ($i = 0; $i < $num['resep']; $i++)
                    <li class="text-md-left">{{ get_value('obat', array_keys($data->allresep)[$i], 'nama_obat') }}
