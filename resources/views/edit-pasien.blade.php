...
@section('konten')
      ...
      <form action="" id="deleteForm" method="post">
        <div class="modal-content">
          ...
          <div class="modal-body">
            {{ csrf_field() }}
            {{ method_field('DELETE') }}
            <p class="text-center">Apakah anda yakin untuk menghapus pasien? Data yang sudah dihapus tidak bisa kembali
            </p>
          </div>
  ...
  <div class="card shadow mb-4">
    @foreach ($datas as $data)
      ...
      <div class="card-body">
        <div class="card-body">
          <code class="mb-6">Data terakhir diperbaharui {{ hitung_usia($data->updated_time) }} yang
            lalu</code>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-4 mb-3 mb-sm-0">
                <select class="form-control " name="Pendidikan_terakhir" placeholder="Pendidikan terakhir"
                  ...
                  <option value="Tidak Sekolah" {{ $data->pendidikan == 'Tidak Sekolah' ? 'selected' : '' }}>Tidak
                    Sekolah</option>
                  ...
                  <option value="Perguruan Tinggi" {{ $data->pendidikan == 'Perguruan Tinggi' ? 'selected' : '' }}>
