      ...
      <form action="" id="deleteForm" method="post">
        <div class="modal-content">
          ...
          <div class="modal-body">
            {{ csrf_field() }}
            {{ method_field('DELETE') }}
            <p class="text-center">Apakah anda yakin untuk menghapus obat? Data yang sudah dihapus tidak bisa kembali
            </p>
          </div>
          ...
          <form class="user" action="{{ route('obat.update') }}" method="post">
            ...
            <div class="form-group row">
              <div class="col-sm-12 mb-3 mb-sm-0">
                <input type="text" class="form-control " name="n_obat" value="{{ $data->nama_obat }}"
