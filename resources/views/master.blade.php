  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item {{ set_menu(['pasien', 'pasien.tambah', 'pasien.edit']) }}">
        ...
        <div id="collapseTwo" class="collapse {{ set_show(['pasien', 'pasien.tambah', 'pasien.edit']) }}"
          aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item {{ set_menu('pasien') }}" href="{{ route('pasien') }}">Daftar Pasien</a>
            <a class="collapse-item {{ set_menu('pasien.tambah') }}" href="{{ route('pasien.tambah') }}">Tambah
              Pasien</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item {{ set_menu(['lab', 'lab.tambah', 'lab.edit']) }}">
        ...
        <div id="collapseThree" class="collapse {{ set_show(['lab', 'lab.tambah', 'lab.edit']) }}"
          aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">

            <a class="collapse-item {{ set_menu('lab') }}" href="{{ route('lab') }}">Daftar Fasilitas Lab</a>
            <a class="collapse-item {{ set_menu('lab.tambah') }}" href="{{ route('lab.tambah') }}">Tambah
              Fasilitas Lab</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item {{ set_menu(['obat', 'obat.tambah', 'obat.edit']) }}">
        ...
        <div id="collapseFour" class="collapse {{ set_show(['obat', 'obat.tambah', 'obat.edit']) }}"
          aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
      ...
      <li
        class="nav-item {{ set_menu(['rm', 'rm.tambah', 'rm.edit', 'rm.list', 'rm.lihat', 'rm.tambah.id', 'tagihan']) }}">
        ...
        <div id="collapseFive"
          class="collapse {{ set_show(['rm', 'rm.tambah', 'rm.edit', 'rm.lihat', 'rm.tambah.id', 'rm.antri']) }}"
          aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item {{ set_menu(['rm']) }}" href="{{ route('rm') }}">Daftar RM</a>
            <a class="collapse-item {{ set_menu(['rm.tambah', 'rm.tambah.id']) }}"
              href="{{ route('rm.tambah') }}">Tambah RM</a>
            <a class="collapse-item {{ set_menu(['rm.antri', 'rm.tambah.id']) }}"
              href="{{ route('rm.antri') }}">Antrian RM</a>
          </div>
        </div>
      </li>
      ...
      <li
        class="nav-item {{ set_menu(['login', 'register', 'user', 'profile.edit', 'profile.edit.admin', 'profile.edit']) }}">
        ...
        <div id="collapsePages"
          class="collapse {{ set_show(['login', 'register', 'user', 'profile.edit', 'profile.edit.admin', 'profile.edit']) }}"
          aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item {{ set_menu(['user']) }}" href="{{ route('user') }}">Daftar Pengguna</a>
            <a class="collapse-item {{ set_menu(['register']) }}" href="{{ route('register') }}">Tambah Pengguna
              Baru</a>
            <a class="collapse-item {{ set_menu(['profile.edit']) }}" href="{{ route('profile.edit') }}">Edit
              Profile</a>
          </div>
        </div>
      </li>
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
            <div class="input-group">
              <label class="form-control bg-light border-0 small" aria-label="Search" aria-describedby="basic-addon2"
                readonly>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="#" id="messagesDropdown" style="padding: 2px;">
                <span
                  class="badge badge-{{ Auth::user()->profesi ? 'primary' : 'warning' }}">{{ Auth::user()->profesi }}</span>
              </a>
            </li>
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                ...
                <img width="60px" class="img-profile rounded-circle"
