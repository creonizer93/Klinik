      ...
      <form action="" id="deleteForm" method="post">
        <div class="modal-content">
          ...
          <div class="modal-body">
            {{ csrf_field() }}
            {{ method_field('DELETE') }}
            <p class="text-center">Apakah anda yakin untuk menghapus pengguna? Data yang sudah dihapus tidak bisa
              kembali</p>
          </div>
          ...
          <tbody>
            @foreach ($users as $user)
              <tr>
                ...
                <td>
                  <a href="{{ Auth::user()->id === $user->id ? route('profile.edit') : route('profile.edit.admin', $user->id) }}"
