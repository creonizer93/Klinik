          ...
          <div class="row justify-content-center">
            <div class="profile-header-container">
              <div class="profile-header-img">
                <img width="250px" class="rounded-circle img-fluid"
                  src="{{ url('/storage/avatars/' . Auth::User()->avatar) }}" <!-- badge -->
                <div class="rank-label-container text-center">
                  <h4><span
                      class="badge badge-dark">{{ $user->profesi == 'Dokter' ? 'dr. ' : '' }}{{ ucwords($user->name) }}</span>
                  </h4>
                </div>
              </div>
            </div>
        ...
        <div class="col-md-8">
          <form method="POST" action="{{ route('profile.simpan') }}" enctype="multipart/form-data">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-6">
                <input id="username" type="text" class="form-control @error('username') is-invalid @enderror"
                  name="username" value="{{ old('username', $user->username) }}" required autocomplete="name">
                @error('username')
                  <span class="invalid-feedback" role="alert" <strong>{{ $message }}</strong>
                  </span>
                @enderror
            ...
            <div class="form-group row">
              ...
              <div class="col-md-6">
                <select id="profesi" type="text" class="form-control @error('profesi') is-invalid @enderror"
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6">
                  <div class="form-check">
                    <input id="admin" type="radio" class="form-check-input" value="0" name="admin"
                      {{ $user->admin == 0 ? 'checked' : '' }}><label class="form-check-label" for="admin"> Tidak</label>
                  </div>
                  <div class="form-check">
                    <input id="admin" type="radio" class="form-check-input" value="1" name="admin"
                      {{ $user->admin == 1 ? 'checked' : '' }}><label class="form-check-label" for="admin"> Ya</label>
                  </div>
                </div>
              </div>
            @endif
            <div class="form-group row">
              ...
              <div class="col-md-6">
                <input type="file" id="avatar" accept="image/*" name="avatar" id="avatarFile" aria-describedby="fileHelp"
